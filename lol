...
rbxname = "FartmanCarlos"
local prefix = "!"
local LPlayer = game.Players.FartmanCarlos
 -- your name on my name (FartmanCarlos)
messageLL = "www . weexploit . net " 
...
game:GetService("StarterGui"):SetCore("SendNotification", { 
	Title = "Weexploit's Alt Control Script";
	Text = "Loaded";
